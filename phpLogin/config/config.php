 ...
 */
define("EMAIL_USE_SMTP", TRUE);
define("EMAIL_SMTP_HOST", "p3plcpnl0040.prod.phx3.secureserver.net");
define("EMAIL_SMTP_AUTH", TRUE);
define("EMAIL_SMTP_USERNAME", "cwp@kennys-spot.org");
define("EMAIL_SMTP_PASSWORD", "kc226975");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", "ssl");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://localhost/cwp-test/phpLogin/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@example.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "cwp@kennys-spot.org");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for kennys-spot");
 ...
 */
define("EMAIL_VERIFICATION_URL", "http://localhost/cwp-test/phpLogin/password_reset.php");
define("EMAIL_VERIFICATION_FROM", "no-reply@example.com");
define("EMAIL_VERIFICATION_FROM_NAME", "cwp@kennys-spot.org");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for kennys-spot.org");
